      ...
      <div className={`min-h-screen font-sans text-[#2D3436] transition-colors duration-1000 ${theme.bg} pb-24 md:pb-0 relative z-0`}>
        ...
        <div className="relative z-10 max-w-2xl mx-auto pt-10 px-6">
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <Link href="/settings" className="p-3 rounded-full bg-white/50 hover:bg-white transition-all shadow-sm text-gray-600">
              <Settings size={24} />
            </Link>
          </div>
          ...
          <motion.div 
            ...
            className="bg-white/40 backdrop-blur-xl border border-white/60 rounded-[40px] shadow-xl overflow-hidden relative"
          >
            ...
            <div className="px-8 pb-8">
              <div className="relative -mt-16 mb-4 flex justify-between items-end">
                <div className="relative">
                  ...
                  <button className="absolute bottom-0 right-0 p-2 bg-[#2D3436] text-white rounded-full shadow-md hover:scale-110 transition-transform">
                    <Camera size={16} />
                  </button>
                </div>
                
                {isEditing ? (
                    <button onClick={handleSaveProfile} className="px-6 py-2 bg-[#2D3436] text-white rounded-full text-sm font-bold shadow-md hover:scale-105 transition-all flex items-center gap-2">
                        <Check size={14}/> Save
                    </button>
                ) : (
                    <button onClick={() => setIsEditing(true)} className="px-6 py-2 bg-white border border-gray-200 text-gray-600 rounded-full text-sm font-bold shadow-sm hover:bg-gray-50 transition-all flex items-center gap-2">
